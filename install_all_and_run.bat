@echo off
echo We should use python 3.9 (3+) for this virtual environment

echo *** Create virtualenv - enter
python -m venv venv

echo *** python-virtual env installed / activate...
